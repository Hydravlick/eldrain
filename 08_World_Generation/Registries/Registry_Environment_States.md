...
related_files:
  ...
  - "[[08_World_Generation/Registries/Registry_Anomaly_Mutations|Registry Anomaly Mutations]]"
  - "[[08_World_Generation/Content/World_Atlas/Sectors/Port/Foreign_Water_Mutation_Lines|Чужая вода: линии мутаций Порта]]"
type: registry
index_route: owner
index_group: world_generation
index_order: 30
index_summary: "Хранит схему и записи: Реестр: локальные средовые состояния."
read_when: "Когда нужен контракт «Реестр: локальные средовые состояния» и его границы с соседними владельцами."
---
# Реестр: локальные средовые состояния

Реестр хранит схему и локальные конфигурации средовых состояний. Универсальная граница их действия находится в [[08_World_Generation/Anomaly/Anomaly_System#Граница локального средового состояния|Anomaly System]].

Связь тега с локальным `state_id` проверяет [[04_Player_Entities/Tags_System]].

## Как игрок читает среду

См. [[08_World_Generation/Anomaly/Anomaly_System#Как игрок читает среду]].
...
Схема описывает один локальный инстанс; правила его действия и последствия принадлежат [[08_World_Generation/Anomaly/Anomaly_System]].
...
Запись конфигурирует [[08_World_Generation/Anomaly/Anomaly_System#3. Метка глубины (The Mark)|правило Метки глубины]]; запрет быстрого выхода и его завершение разрешаются у System owner. Запись не вводит отдельный resolver.
