...
index_order: 60
index_summary: "Хранит схему и записи: Registry: Raid Interfaces."
read_when: "Когда нужен контракт «Registry: Raid Interfaces» и его границы с соседними владельцами."
---
...
Every row names one producer and one consumer. This registry stores neither a duplicate state machine nor a fallback owner. `UR-001`, `UR-002`, and `UR-003` remain unresolved in [[09_Project_Management/Open_Design_Decisions|the unresolved registry]] and are not resolved by an interface row.
