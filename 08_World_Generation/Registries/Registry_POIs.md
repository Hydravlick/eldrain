...
Представление фаз, выбор цели и переход к подготовке принадлежат [[08_World_Generation/Hub/Hub_Map_Table]] и [[08_World_Generation/Generation/Raid_Approach_and_Entry]].
...
[[08_World_Generation/Hub/Hub_Map_Table]] показывает опубликованную ревизию и известные источники; [[08_World_Generation/Generation/Raid_Approach_and_Entry]] раскрывает и подтверждает ставку. Поля POI не выбирают точку высадки и не дают Бригадиру перки Пешки.
