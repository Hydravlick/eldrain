...
2.  **Raid State (Volatile):** После подтверждённого физического входа (`Breach`) снаряжение Пешки фиксируется в рейдовой сессии, а её переносимый груз существует как временная custody-запись.
    * *Успех:* Обычный Порог, а в применимом личном исходе — Рассвет, создаёт защищённый манифест; только он переносит допустимый груз в основной схрон.
    * *Потеря:* При летальном исходе груз не попадает в схрон владельца. Он остаётся в физической custody тела/мира и дальше разрешается владельцами Inventory/World custody; Recovery не возвращает его как скрытая форма экстракции.
    * *Краш до физического входа:* Если durable Breach ещё не принят, рейдовые Presence, ParticipationClaim и custody-записи не существуют.
...
Как указано в [[08_World_Generation/Generation/07_Server_Lifecycle|Server_Lifecycle]], рейдовый инстанс живёт 6 часов, проходит Печать в 05:00 и завершает Apex Рассветом.
