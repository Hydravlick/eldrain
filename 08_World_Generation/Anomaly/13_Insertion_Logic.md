...
index_order: 90
index_summary: "Задаёт правила и последствия системы «Insertion Logic»."
read_when: "Читайте при изменении входов, состояний, стоимости или последствий системы «Insertion Logic»."
system: raid_ingress
tags:
  - ingress
  - admission
