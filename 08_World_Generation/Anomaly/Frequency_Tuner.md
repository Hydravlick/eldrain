...
index_order: 200
index_summary: "Описывает представление региона, качества соединения и доступности сервиса."
read_when: При проверке сетевого UI и его границы с выбором рейдовой цели.
---
# Регион и качество соединения

`Frequency Tuner` / «Настройка частоты» — прежняя интерфейсная метафора, сохранённая в пути документа. Она не означает, что житель меняет частоту мира, батареи или Сущности для улучшения ping. Обязательной диегетической процедуры здесь нет. Окончательное имя экрана не выбирается этим pass.

## Responsibility

Этот UI — только player-facing представление региона, качества соединения и доступности сервиса. Он не выбирает конкретный raid target, не открывает повторный вход и не владеет matchmaking-решением.
