...
Игровой MVP использует выбранные 3 расы x 3 класса и обязан закрыть все 9 видимых сочетаний. Полная сетка 5x5 сохраняется в реестрах и матрицах как внутренняя карта расширения.

Текущие 9 curated-комбо не образуют завершенную 3x3 и не считаются готовым стартовым набором до выбора MVP-пула и заполнения всех его пар.
