...
| `personal_tags` | Chronicle, mastery, мутации, реликтовые отпечатки, шрамы и незавершённые цели конкретного человека | Access Price, стоимость тела или право печатать снаряжение |
...
Пешка хранит личность и до четырёх Major Tags, но не присваивает себе весь билд аккаунта. Hero-kit, доступные Frame, рецепты, схрон, городские сервисы и модульный каталог переживают KIA; личные теги не меняют базовый gunfeel, P/Q/E, арсенал, proficiency или module capacity. Foundling получает один Origin раньше Ward, но не более высокий предел.
