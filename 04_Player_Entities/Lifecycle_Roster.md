...
Civic Attire может заменить Термос в Body Base, если совпадает native_fit. Тогда модульных слотов нет. Если Пешка погибает в чужом наряде, Attire выпадает по обычным правилам; город сам решает, станет ли оставленная вещь памятью, товаром или рабочим предметом. Полный контракт: [[07_Gear_Inventory/Civic_Attire|Одежда как дом]].
