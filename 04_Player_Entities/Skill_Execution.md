...
Это примеры границ модели, без новых записей способностей. Ниже заданы точные исполнители `body`, `device`, `environment_node`, энергетические contracts и Recovery. Эта страница владеет общей грамматикой исполнения; поля и иллюстративные записи находятся в [[04_Player_Entities/Registries/Registry_Skill_Types]].
