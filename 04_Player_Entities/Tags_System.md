...
В новой системе теги являются не только цифрами, а **векторными переключателями**. Они могут добавлять тактический вектор, блокировать вектор, менять proficiency tier или обходить запрет арсенала. Любое усиление обязано иметь цену: атрибут, резонанс, слабость, шум, токсичность или ограничение веса.
...
3.  **Теги Атрибутов (Attribute Tags):** 
	...
	- В Dataview: `[attr_delta:: TRQ +2, SNS -1]`.
