...
Полный порядок сборки задаёт [[04_Player_Entities/Combat_Profile_Pipeline|Combat Profile Pipeline]], данные конкретных полевых профилей — [[04_Player_Entities/Registries/Registry_Combos|Registry Combos]].
