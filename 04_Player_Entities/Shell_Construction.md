...
Добровольное Closure прекращает доступ к embodied возможностям для deployment; unfinished work переоценивается, completed results сохраняются у своих owners. Отдельный terminal поступок может создать новое authored внешнее следствие по контракту Life Closure. Оно не копирует тело, Traits, Proficiency, Scars или личные связи преемнику и не требует постоянно действующего CLOSED человека. Долгая жизнь без такого окончания допустима.
