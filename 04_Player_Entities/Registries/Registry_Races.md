...
related_files:
  ...
  - "[[02_World_Lore/Culture_Design_Grammar|Исторический контракт народов]]"
type: registry
index_route: owner
index_group: player_entities
index_order: 40
index_summary: "Хранит схему и записи: Реестр: Расы."
read_when: "Когда нужен контракт «Реестр: Расы» и его границы с соседними владельцами."
---
# Реестр: Расы

> **MVP:** Зафиксированы Ёж, Крыса и Белка. Жаба и Ящерица сохраняются как каноническая карта расширения с телесной и культурной причинностью, но без готовых MVP-комбинаций.
>
...
>
> `base_vector` принадлежит аналитической карте [[04_Player_Entities/Two_Paradox_Vector_Matrix|Двойного Парадокса]]. Он описывает место телесной линии в общей топологии и не является RPG-атрибутом, числовым бонусом или готовой способностью.
