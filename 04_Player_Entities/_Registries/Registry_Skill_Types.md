...
### Аномальная процедура (Anomaly Procedure)
[id:: anomaly_procedure]
[skill_type:: anomaly_procedure]
* **Описание:** Устройство или подготовленный контур временно работает с конкретным правилом, защитой или узлом Аномалии.
* **Требование:** Явно названный физический источник, цель процедуры, канал, телеграф, `Recovery` и исход прерывания.
* **Энергетический контракт:** `device`; телесная замена не включается автоматически.
* **Контригра:** линия, разрушение устройства, прерывание пользователя, смена цели или среды.
---
...
- **Скалируется от:** атрибут, специализация, оружие или тег.
