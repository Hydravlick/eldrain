...
> **MVP:** В игровой вертикальный срез войдут 3 выбранных класса. Для них должно существовать полное покрытие всех 9 сочетаний с тремя MVP-расами. Остальные классы остаются в реестре как направление расширения. Конкретная тройка еще не утверждена.
...
#### Описание:
	Прикладная наука, химия, инженерия. Те, кто стабилизирует людей, механизмы и маршруты. Самый ценный слот в пати.
#### Примеры:
