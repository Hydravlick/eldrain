...
Сравнительная формула трёх практик не является завершённым каноном ролей. До прототипа трёх полных hero-kit одной расы каждая страница практики задаёт только собственный читаемый метод и границы; условие проверки находится в [[09_Project_Management/TODO#1. Сквозной vertical slice|TODO]].
