...
Конкретные Scar и их embodied consequences хранятся по [[04_Player_Entities/Tags_System#Scar и адресное лечение|Scar contract]]. Подтверждённое адресное лечение может снять названное постоянное ограничение этого источника; Morphology публикует новую revision только при реальном изменении устойчивой геометрии или физического интерфейса. Пересчёт MaxCapacity принадлежит [[05_Combat_Survival/Combat_Consumables|Health]] и сам по себе не меняет MorphologySnapshot. Facility preview или бесплатная медицина Scar не удаляют.
