    ...
    try {
        ...
        title.innerHTML = `
            ...
            <div style="font-size:0.92em; color:var(--text-muted); margin-top:5px; line-height:1.45;">
                Каждая линия показывает один смысл связи. Стрелка отвечает на вопрос "кто влияет на кого"; двусторонние связи получают стрелки с двух сторон. Игровой MVP должен читать завершенную выбранную матрицу 3x3; полная 5x5 остается внутренней картой расширения. Текущий набор из 9 curated-комбо еще не образует такую 3x3.
            </div>
        `;
