    ...
    try {
        ...
        title.innerHTML = `
            ...
            <div style="font-size:0.92em; color:var(--text-muted); margin-top:5px; line-height:1.45;">
                Каждая линия показывает один смысл связи. Стрелка отвечает на вопрос "кто влияет на кого"; двусторонние связи получают стрелки с двух сторон. Игровой MVP читает зафиксированную матрицу Ёж/Крыса/Белка × Авангард/Технократ/Странник; полная 5x5 остается внутренней картой расширения. Наличие девяти слотов не означает, что их контент уже утверждён.
            </div>
        `;
