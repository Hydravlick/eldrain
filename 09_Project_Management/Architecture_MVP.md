...
- Для registry-файлов ссылаться на сам реестр или на конкретный заголовок объекта, например [[03_Factions_Societies/_Registries/Registry_Factions#Хранители (The Keepers)|Keepers]].
