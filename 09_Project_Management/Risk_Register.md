...
| R07 | 9 комбо из 25 выглядят как неполнота | Игровой MVP показывает выбранные 3 расы x 3 класса с полным покрытием 9 комбинаций; полная 5x5 остается внутренней картой расширения. Конкретный состав 3x3 еще нужно выбрать и закрыть контентом | in_progress | `Registry_Combos`, `Combat_Profile_Pipeline`, `00_Balance` |
