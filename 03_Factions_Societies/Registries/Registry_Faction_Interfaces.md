...
related_files:
  ...
  - "[[08_World_Generation/Content/Faction_Encounter_Seeds]]"
  - "[[03_Factions_Societies/Registries/Registry_Factions|Реестр фракций]]"
type: registry
index_route: owner
index_group: factions_societies
index_order: 20
index_summary: "Хранит схему и записи: Реестр игровых интерфейсов фракций."
read_when: Когда нужен контракт «Реестр игровых интерфейсов фракций» и его границы с соседними владельцами.
---
...
- Каждый `faction_id` существует в [[03_Factions_Societies/Registries/Registry_Factions|Registry_Factions]].
...
[mechanic_owner_ref:: MISSING_OWNER]
[dependency_refs:: [[08_World_Generation/Hub/Hub_Map_Table|Hub Map Table]]]
...
[mechanic_owner_ref:: MISSING_OWNER]
[dependency_refs:: [[07_Gear_Inventory/Registries/Registry_CraftingRecipes|Registry Crafting Recipes]]]
