...
Здесь нет карусели тел, trait-preview, reroll, таймера ожидания или обязательной экстракции для восстановления нормального доступа. Ward начинает без проявленного gameplay-trait и способен обрести Chronicle только через собственное пережитое событие.
