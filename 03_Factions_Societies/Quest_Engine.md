...
### Стартовая Цепочка: `Blood_Debt`

Первый обучающий контракт может быть принудительным долгом перед Теневым Картелем.

1. **Инцидент:** игрок портит стабилизированный товар Картеля.
2. **Долг:** на аккаунт вешается сумма в Резах или набор обязательных услуг.
3. **Отработка:** ранние контракты обучают лутингу, эвакуации, стабилизации, продаже и репутационным последствиям.
4. **Выбор:** игрок может выплатить долг, выполнить грязную работу или продать информацию другой фракции, запустив нулевую сумму репутации.

Цель цепочки - дать личную экономическую причину идти в рейды без героического пафоса.
...
* **Контекст:** Прогресс аккаунта — непрерывная история решений Осколка и его ростера.
* **Срок:** Бессрочно.
