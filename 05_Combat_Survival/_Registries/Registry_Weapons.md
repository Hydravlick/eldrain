...
| Дальний | `pulse_tool_1h`, `condenser_rig_2h`, `scatter_valve_2h` | сорвать готовность, держать одну линию или поставить краткую веерную преграду |
| Дальний | `tether_launcher_2h`, `needle_thrower_2h`, `catalyst_rig_2h` | связать маршрут, тихо использовать мягкую зону или открыть аномальную защиту |
| Аксессуар | `interposition_panel_1h` | закрыть один угол перехода, не превратив фронтальное стояние в оптимум |
...
[[09_Project_Management/Verify_Weapons_Contract|Verify_Weapons_Contract]] проверяет активные ID фреймов, хват, данные экземпляров, Combo mastery и контракт тегов. Числа урона, Heat, точные задержки и веса остаются предметом прототипа, а не скрытого Power Score.
