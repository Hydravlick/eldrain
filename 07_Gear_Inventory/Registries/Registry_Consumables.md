...
index_order: 20
index_summary: "Хранит схему и записи: Реестр: необходимые расходники и экспедиционные предметы."
read_when: "Когда нужен контракт «Реестр: необходимые расходники и экспедиционные предметы» и его границы с соседними владельцами."
---
# Реестр необходимых расходников и экспедиционных предметов

Реестр хранит подтверждённые медицинские, доступные и доказательные предметные процедуры. Расходник уничтожается или истощается конкретным применением. Батареи являются источниками энергии и описываются в [[05_Combat_Survival/Magic_Batteries|Magic_Batteries]], а не как второй payload боевого навыка.
...
Числа, токсичность, стек и конкретные типы отходов остаются прототипными. Границы допустимых расходников и навыков: [[05_Combat_Survival/Combat_Consumables#4. Запреты|запреты Combat Consumables]].
