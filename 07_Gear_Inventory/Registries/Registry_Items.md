...
> **Граница покрытия Чужой воды:** [[08_World_Generation/Registries/Registry_Anomaly_Mutations|реестр мутаций]] называет существ и стадии, но сам по себе не создаёт их ингредиенты. Пока отдельные записи не утверждены здесь, образец для изучения, обычный ингредиент и зрелый T3-материал не считаются взаимозаменяемыми, а распознавание ранней линии не требует несуществующего дорогого дропа. Ценности, вес, стаки и вероятности задаются только полноценной предметной записью и владельцем добычи.
...
- **Применение:** Крафт болтов, фильтров, простых инструментов и каркасов.
...
- **Особое Свойство (Incombustible):**
    ...
    - **Штраф:** Пока находится в инвентаре, Stress спадает медленнее, а редкие эфирные искажения могут срабатывать чаще.
...
## 0. Нулевой пациент: шаблон предмета

### Шаблон Предмета (Template Item)
[item_id:: template_item]
