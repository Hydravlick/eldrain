...
tags:
  ...
  - active_tanking
---
> [!TODO] Броня и линии Чужой воды
> - [ ] Добавить проверяемые теги взаимодействия со спорами, видимыми наростами и белой меткой, не создавая комплект полной иммунности.
> - [ ] Проверить, как тяжёлая защита меняет выбор между быстрым погодным окном, сухим обходом и намеренным вызовом ответа.
> - **Основа:** [[08_World_Generation/_Registries/Registry_Anomaly_Mutations|Registry_Anomaly_Mutations]]. Значения защиты не меняются без отдельной модели.
